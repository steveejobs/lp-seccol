...
export function InstrumentsPage() {
  return (
    <main>
      ...
      <ActionSection title="Defina a instrumentação necessária para o seu processo." />
    </main>
  )
}
